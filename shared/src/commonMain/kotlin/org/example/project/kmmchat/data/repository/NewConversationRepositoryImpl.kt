...
class NewConversationRepositoryImpl(
    private val userDataSource: UserDataSource
): NewConversationRepository {
    override suspend fun searchUsers(query: String, token: String): Result<Users> {
        return when(val result = userDataSource.searchUsers(query = query, token = token)){
